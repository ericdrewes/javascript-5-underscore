...
const myEmployees = [
	...
	},
	{
		...
		latitude: 59.052836,
		longitude: 78.764631,
		tags: ['aute', 'adipisicing', 'ad', 'excepteur', 'dolor', 'occaecat', 'minim'],
		friends: [
			{
				id: 0,
	...
	},
	{
		...
		latitude: 87.070986,
		longitude: -65.66618,
		tags: ['anim', 'magna', 'tempor', 'quis', 'aliquip', 'reprehenderit', 'reprehenderit'],
		friends: [
			{
				id: 0,
	...
	},
	{
		...
		latitude: 25.339192,
		longitude: -8.587004,
		tags: ['aliquip', 'proident', 'voluptate', 'do', 'deserunt', 'dolore', 'in'],
		friends: [
			{
				id: 0,
				name: 'Barber Ellis'
